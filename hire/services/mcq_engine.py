...
def grade_mcq(round_id, answers: dict):
    ...
    Returns: { total_marks, obtained_marks, detail: {qid: {correct, marks_awarded}} }
    """
    total = 0.0
    obtained = 0.0
    detail = {}
    ...
    for qid_str, chosen in answers.items():
        ...
        obtained += awarded
        detail[qid_str] = {"correct": correct, "marks_awarded": awarded, "marks_total": q.marks}
    return {"total_marks": total, "obtained_marks": obtained, "detail": detail}
